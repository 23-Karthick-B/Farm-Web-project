...
-- Table: Products (to define product types separately)
CREATE TABLE Products (
	Product_ID INT PRIMARY KEY auto_increment,
    Product_Type VARCHAR(100),
    Product_Name VARCHAR(100) UNIQUE -- Ensuring unique product names
);
...
(15,  'Spice', 'Clove'),
(16,  'Herb', 'Rosemary'),
(17,  'Vegetable', 'Bell Pepper'),
(18,  'Fruit', 'Pomegranate'),
(19,  'Grain', 'Buckwheat'),
...
-- Farmers with multiple products (scattered)
(26,  'Vegetable', 'Potato'),         -- Farmer 3 (Apple + Potato)
(27,  'Spice', 'Coriander'),           -- Farmer 7 (Mint + Coriander)
(28,  'Fruit', 'Watermelon'),          -- Farmer 9 (Corn + Watermelon)
(29,  'Spice', 'Cardamom'),           -- Farmer 12 (Mango + Cardamom)
(30,  'Fruit', 'Guava'),              -- Farmer 15 (Clove + Guava)
(31,  'Grain', 'Quinoa'),             -- Farmer 18 (Pomegranate + Quinoa)
(32,  'Herb', 'Parsley'),              -- Farmer 2 (Tomato + Parsley)
(33,  'Fruit', 'Strawberry'),          -- Farmer 4 (Rice + Strawberry)
(34,  'Grain', 'Millet'),              -- Farmer 6 (Carrot + Millet)
(35,  'Herb', 'Basil'),               -- Farmer 11 (Onion + Basil)
(36,  'Fruit', 'Pineapple'),          -- Farmer 13 (Barley + Pineapple)
(37,  'Spice', 'Pepper'),             -- Farmer 16 (Rosemary + Pepper)
(38,  'Fruit', 'Grapes'),             -- Farmer 20 (Broccoli + Grapes)
(39,  'Spice', 'Saffron'),             -- Farmer 8 (Banana + Saffron)
(40,  'Grain', 'Sorghum'),             -- Farmer 5 (Turmeric + Sorghum)
(41,  'Herb', 'Thyme'),               -- Farmer 10 (Cinnamon + Thyme)
(42,  'Fruit', 'Papaya'),             -- Farmer 14 (Spinach + Papaya)
(43,  'Spice', 'Ginger'),             -- Farmer 19 (Buckwheat + Ginger)
(44,  'Grain', 'Foxtail Millet'),     -- Farmer 22 (Pumpkin + Foxtail Millet)
(45,  'Fruit', 'Blueberry');          -- Farmer 25 (Rye + Blueberry)
...
INSERT INTO Sold_Products (Farmer_ID, Product_ID, Product_Name, Quantity_Sold, Price, Puchase_Date) VALUES
